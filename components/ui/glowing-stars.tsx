  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        background: isGlowing ? "#10b981" : "#666",
      }}
      transition={{
        duration: 2,
        ease: "easeInOut",
...
const Glow = ({ delay }: { delay: number }) => {
  return (
    <motion.div
      ...
      className="absolute  left-1/2 -translate-x-1/2 z-10 h-[4px] w-[4px] rounded-full bg-emerald-500 blur-[1px] shadow-2xl shadow-emerald-400"
    />
  );
};
