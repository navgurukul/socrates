...
// Daily battle: List Rendering (daily variant)
// Independent from track/arc curriculum, used only by the daily battle system.

export const dailyListRendering: Challenge = {
  id: "daily-list-rendering-mismatch",
  title: "Daily: List Rendering Mismatch",
  description: `
# Daily Bug: List Items Duplicating
    ...
    "package.json": {
      ...
      file: {
        contents: JSON.stringify(
          {
            name: "daily-list-rendering-challenge",
            private: true,
            version: "0.0.0",
            type: "module",
            scripts: {
...
<html lang="en">
  <head>
    ...
    <title>Daily List Rendering Bug</title>
