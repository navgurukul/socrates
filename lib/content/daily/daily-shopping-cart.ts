...
// Daily battle: Shopping Cart (daily variant)
// Independent from track/arc curriculum, used only by the daily battle system.

export const dailyShoppingCart: Challenge = {
  id: "daily-shopping-cart-bug",
  title: "Daily: Stale Cart Total",
  description: `
# Daily Bug: Cart Total Not Updating
    ...
    "package.json": {
      ...
      file: {
        contents: JSON.stringify(
          {
            name: "daily-shopping-cart-challenge",
            private: true,
            version: "0.0.0",
            type: "module",
            scripts: {
...
<html lang="en">
  <head>
    ...
    <title>Daily Shopping Cart Bug</title>
