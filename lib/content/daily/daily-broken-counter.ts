...
// Daily battle: Broken Counter (daily variant)
// This uses the same underlying project as the track battle but is scoped
// exclusively to the daily battle system via its own ID and registry.

export const dailyBrokenCounter: Challenge = {
  id: "daily-broken-counter",
  title: "Daily: Broken Counter UI",
  description: `
# Daily Bug: Counter Not Incrementing
    ...
    "package.json": {
      ...
      file: {
        contents: JSON.stringify(
          {
            name: "daily-broken-counter-challenge",
            private: true,
            version: "0.0.0",
            type: "module",
            scripts: {
...
<html lang="en">
  <head>
    ...
    <title>Daily Broken Counter</title>
