...
export const buttonDisabledBattle: Battle = {
  id: "button-disabled-incorrectly",
  trackId: "frontend-debugging",
  arcId: "js-logic-and-state",
  title: "Button Disabled Incorrectly",
  description: `
# Bug Report: Submit Button Always Disabled
    ...
    "package.json": {
      ...
      file: {
        contents: JSON.stringify(
          {
            name: "button-disabled-challenge",
            private: true,
            version: "0.0.0",
            type: "module",
            scripts: {
...
<html lang="en">
  <head>
    ...
    <title>Button Disabled Bug</title>
